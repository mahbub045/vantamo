    ...
    <div className="min-h-screen flex bg-[var(--bg)]">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-bold font-display text-[var(--text)]">Sign in</h2>
          ...
          <div className="mt-6 p-3 rounded-lg bg-[var(--bg-subtle)] border border-[var(--border-subtle)]">
            <p className="text-xs text-[var(--text-muted)]">
              Demo: <span className="text-[var(--text)] font-mono">admin@vantamo.io</span> / <span className="text-[var(--text)] font-mono">password123</span>
            </p>
          </div>
        </div>
      </div>
